...
<!-- SECTION BANNIERE -->
<section class=" bg-black bg-opacity-40 bg-blend-darken bg-hero bg-no-repeat bg-cover bg-center bg-fixed py-10 px-5 sm:py-16 sm:px-10 md:py-24 md:px-20 lg:py-32 lg:px-50 xl:py-44 xl:px-80">
...
<section class="bg-white shadow-slate-400 shadow-md py-7 px-5 sm:py-14 sm:px-10 md:py-20 md:px-12 lg:py-20 lg:px-40 xl:py-24 xl:px-60 ">
    <div class="container mx-auto flex-col items-center ">
        ...
        <!-- Previous button -->
            ...
            <div class="slide md:w-[500px] sm:w-[400px] w-[220px]">
                <img class="w-full md:h-[350px] sm:h-[250px] h-[120px]" src="<?= $product->getImage()?>">
