...
<section class="container mx-auto py-32 px-48">
    ...
    <div class="container mx-auto bg-eggshell px-16 py-20">
        <p class="text-center text-3xl uppercase mb-20 font-light">Récapitulatif de votre commande</p>
        ...
        <div class="bg-white p-10">
            ...
            <p class="text-center text-3xl uppercase mt-20 font-light">Merci pour votre commande</p>
        </div>
