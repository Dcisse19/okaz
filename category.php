...
<section class="py-10 px-40">
    <div class="container p-10">
        ...
        <form action="" class="flex justify-start space-x-6 mt-6">
            <div class="">
                <input value="" class="border rounded-lg border-darkgrey py-2 px-4 outline-orange-500 shadow-lg" placeholder="Prix MIN" type="text" name="min_price" id="min_price">
            </div>
            <div class="">
                <input value="" class="border rounded-lg border-darkgrey py-2 px-4 outline-orange-500 shadow-lg" placeholder="Prix MAX" type="text" name="max_price" id="max_price">
            </div>
            <button class="font-semibold text-lg uppercase tracking-wider hover-text-orange">Filtrer
            </button>
        </form>
